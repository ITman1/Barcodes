...
QR kódy lze od ostatních 2D kódů rozeznat podle výrazných značek ve třech rozích 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.43}{
      \includegraphics{fig/QRCodeModel12Comparision.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.25}{
      \includegraphics{fig/microQRIntroducion.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.55}{
      \includegraphics{fig/QRCodesStructure.pdf}
    } 
...
Z hlediska rozměrů má QR kód 2005 verze 1 rozměry 21x21 bodů. Každá další
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.30}{
      \includegraphics{fig/QRCodeVersionMetainformation.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.42}{
      \includegraphics{fig/QRCodeFormatMetainformation.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.85}{
      \includegraphics{fig/QRCodeDataSegments.pdf}
    } 
...
Proces dekódování a případné opravy chyby v RS kódu je více komplikovaný. Jeho
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.68}{
      \includegraphics{fig/ReedSolomonDecodingProcess.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.70}{
      \includegraphics{fig/CreatingOutputPatternProcess.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.45}{
      \includegraphics{fig/PuttingDataCodewordsIntoQRCode.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.65}{
      \includegraphics{fig/QRCodeReferenceReadingProcess.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.75}{
      \includegraphics{fig/QRCodeReadingProcess.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.85}{
      \includegraphics{fig/DependencyOfSizeOfThresholdBlockToQRCodeSizes.pdf}
    }
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.83}{
      \includegraphics{fig/QRCodeDetectionWithScanline.pdf}
    }
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.75}{
      \includegraphics{fig/ContourTopology.pdf}
    }
...
Výsledkem hledání kontury bývá vždy množina bodů, která sleduje danou strukturu,
...
\begin{figure}[H]
  \begin{center}
    \scalebox{1.0}{
      \includegraphics{fig/FinderMarkContourDetection.pdf}
    }
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.70}{
      \includegraphics{fig/QRCodeDetectionProcess.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.45}{
      \includegraphics{fig/QRCodeArea.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.60}{
      \includegraphics{fig/DeterminingTheFourthPointForTransformation.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.30}{
      \includegraphics{fig/DeterminingTheVersionOfQRCode.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.65}{
      \includegraphics{fig/QRReaderApplicationLibraryDependency.pdf}
    } 
...
\begin{figure}[H]
  \begin{center}
    \scalebox{0.85}{
      \includegraphics{fig/QRReaderApplicationNativeCalls.pdf}
    } 
...
Následující kapitola pojednává o samotné realizaci algoritmů a navržené 
...
výrazně méně.
 ...
 \begin{figure}[H]
  \begin{center}
    \scalebox{0.53}{
      \includegraphics{fig/detectionFPS.pdf}
    }
...
\ref{decodeFPS}.
 ...
 \begin{figure}[H]
  \begin{center}
    \scalebox{0.53}{
      \includegraphics{fig/decodeFPS.pdf}
    }
...
případných optimalizací.
 ...
 \begin{figure}[H]
  \begin{center}
    \scalebox{0.50}{
      \includegraphics{fig/decodingStepsOverview.pdf} }
...
Detekce QR kódů v \csuv{běžně} strukturovaném reálném obraze, jehož rozlišení
