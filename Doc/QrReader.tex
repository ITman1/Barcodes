...
mobilní platformu Android. V teoretické části analyzuje strukturu QR kódů včetně
způsobu kódování obsažených informací a uvádí referenční přístupy, jakými lze
...
pod vedením pana Ing. Lukáše Maršíka. Uvedl jsem všechny literární prameny a
