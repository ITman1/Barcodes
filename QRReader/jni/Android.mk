...
LOCAL_SRC_FILES          += $(patsubst %,../../BarcodesLibrary/%,$(shell $(call oss_cat,"..\BarcodesLibrary\src_list.TXT")))
...
LOCAL_SRC_FILES          := JNI_QRBarcodesLibrary.cpp $(foreach mod, jDetectedMark jImage jPoint jSize jDataSegment, wrappers/$(mod).cpp)
LOCAL_LDLIBS             += -llog -ldl -lz
